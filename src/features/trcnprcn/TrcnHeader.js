...
import TrcnSearchCondition from './TrcnSearchCondition';
...
export default function TrcnHeader() {
  ...
  return (
    <React.Fragment>
      ...
      <TrcnSearchCondition open={state.searchCondition} onClose={closeSearchCondition} />
    </React.Fragment>
  );
}

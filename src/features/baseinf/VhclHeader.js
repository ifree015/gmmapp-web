...
import VhclSearchCondition from './VhclSearchCondition';
...
export default function VhclHeader() {
  ...
  if (!searchParams.get('useYn')) {
    searchParams.append('useYn', 'Y');
  }
